<div class="box configcompañia">
    ...
    <div class="mb-5">
        <label for="typo_documento" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Tipo Documento</label>
        <select id="typo_documento" name="typo_documento" class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
    ...
    <div class="mb-5">
        <label for="numero_documento" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Numero de Documento</label>
