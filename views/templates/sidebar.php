        ...
        <ul class="space-y-2 pt-4">
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              ...
              <li>
                <a href="#" class="flex items-center p-2 pl-11 w-full text-lg font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100  ">Set de pruebas</a>
              </li>
              <li>
          ...
          <li>
            ...
            <ul id="dropdown-sales" class="hidden py-2 space-y-2">
              <li>
                <a href="#" class="flex items-center p-2 pl-11 w-full text-lg font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100  ">Invoice</a>
              </li>
            </ul>
          </li>
          <li>
